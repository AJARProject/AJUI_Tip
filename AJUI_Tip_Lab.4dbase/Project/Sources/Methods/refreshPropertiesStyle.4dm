...
For ($i;0;Form:C1466.properties.length-1)
	If (Form:C1466.properties[$i].property="margin")
		If (Form:C1466.defaultValues[Form:C1466.properties[$i].formula]().left=Form:C1466.tips[Form:C1466.currentNameTemplate][Form:C1466.properties[$i].formula]().left)  //margin only left value
			APPEND TO ARRAY:C911(bgStylesValue;0)
		Else 
			APPEND TO ARRAY:C911(bgStylesValue;Bold:K14:2)
		End if 
	Else 
		If (Form:C1466.defaultValues[Form:C1466.properties[$i].formula]()=Form:C1466.tips[Form:C1466.currentNameTemplate][Form:C1466.properties[$i].formula]())
			APPEND TO ARRAY:C911(bgStylesValue;0)
		Else 
			APPEND TO ARRAY:C911(bgStylesValue;Bold:K14:2)
		End if 
