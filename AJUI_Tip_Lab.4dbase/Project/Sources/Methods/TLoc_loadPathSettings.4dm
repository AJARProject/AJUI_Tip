...
If (False:C215)
	  ...
	  // Date and time: 10.12.19, 10.12:10
	  // ----------------------------------------------------
...
$file:=Folder:C1567(fk user preferences folder:K87:10).folder("AJUI_TipTempPref").file("AJUI_TipTempPref.json")
$globalPath:=Get 4D folder:C485(Current resources folder:K5:16;*)+"AJUI_Tip_Templates"+Folder separator:K24:12
If ($file.exists)
